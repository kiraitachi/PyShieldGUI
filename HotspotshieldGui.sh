...
elif [ "$answer" = 0 ] && [ "$option" = "hotspotshield locations" ]; then
    kdialog --msgbox "`$option`"

elif [ "$answer" = 0 ] && [ "$option" = "hotspotshield status" ]; then
    kdialog --msgbox "`$option`"
